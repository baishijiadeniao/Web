...
void WebServer::init(int port, string user, string passWord, string databaseName, int log_write, 
                     int opt_linger, int trigmode, int actor_model, int close_log, int sql_num, int thread_num)
{
    m_port = port;
    m_user = user;
    m_password = passWord;
...
void WebServer::sql_pool()
{
    ...
    m_connection_pool->init("localhost", m_user, m_password, m_database_name, 5, m_sql_num, m_close_log);
