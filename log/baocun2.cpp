...
bool loger::init(const char *file_name, int close_log, int log_buf_size, int split_lines, int max_queue_size)
{
...
void loger::write_log(int level, const char *format, ...)
{
    ...
    if (m_today != my_tm.tm_mday || m_count % m_split_lines == 0) //everyday log
    {
        ...
        {
            snprintf(new_log, 255, "%s%s%s.%lld", dirname, tail, logname, m_count / m_split_lines);
        }
